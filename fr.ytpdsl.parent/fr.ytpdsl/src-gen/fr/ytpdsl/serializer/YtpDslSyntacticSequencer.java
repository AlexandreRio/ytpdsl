...
public class YtpDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected YtpDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (YtpDslGrammarAccess) access;
